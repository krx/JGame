...
public class EventHandler implements KeyListener, MouseListener, MouseMotionListener {
	...
	public void mousePressed(MouseEvent e) {
		if (SwingUtilities.isLeftMouseButton(e)) Mouse.left=true;
		if (SwingUtilities.isMiddleMouseButton(e)) Mouse.middle=true;
		if (SwingUtilities.isRightMouseButton(e)) Mouse.right=true;
	...
	public void mouseReleased(MouseEvent e) {
		if (SwingUtilities.isLeftMouseButton(e)) Mouse.left=false;
		if (SwingUtilities.isMiddleMouseButton(e)) Mouse.middle=false;
		if (SwingUtilities.isRightMouseButton(e)) Mouse.right=false;
